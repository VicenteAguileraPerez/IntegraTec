...
public class PropiertiesHelper {
    ...
    public static final String [] MATERIAS  ={"Seleccione una materia...","Álgebra", "Álgebra lineal", "Cálculo diferencial", "Cálculo integral", "Cálculo vectorial", "Ecuaciones diferenciales", "Probabilidad y estadística","Métodos numéricos","Química", "Física"};
