...
public class PropiertiesHelper {
    ...
    public static final String [] LUGARES ={"Seleccione un lugar...","Biblioteca", "Telemática", "Edificio A", "Edificio F"};
    ...
    public static final String [] SEMESTRES ={"Seleccione un semestre..","Primero A", "Primero B", "Segundo A", "Segundo B", "Tercero A", "Tercero B", "Cuarto A", "Cuarto B", "Quinto A", "Quinto B", "Sexto A", "Sexto B", "Séptimo A", "Séptimo B", "Octavo A", "Octavo B", "Noveno A", "Noveno B", "Decimo A", "Decimo B"};
